...
-- EC2 Instances
select instance_id, instance_type, region, availability_zone, state_name, launch_time
from aws_ec2_instance;

-- S3 Buckets
select name, region, versioning_status, has_public_access_block, encryption_rules
from aws_s3_bucket;
...
-- EBS Volumes
select volume_id, region, size, state, encrypted, attached_instance_id
from aws_ebs_volume;
